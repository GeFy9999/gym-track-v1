...
INSERT INTO "new_User" ("authProvider", "barbellModeEnabled", "createdAt", "email", "id", "language", "name", "password", "recoveryEmail", "resetToken", "resetTokenExpiry", "restTimerEnabled", "restTimerSeconds", "weightUnit") SELECT "authProvider", "barbellModeEnabled", "createdAt", "email", "id", "language", "name", "password", "recoveryEmail", "resetToken", "resetTokenExpiry", "restTimerEnabled", "restTimerSeconds", "weightUnit" FROM "User";
DROP TABLE "User";
